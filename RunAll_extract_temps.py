...
def usage():
    print("RunAll_extract_temps.py [-o] [-s] [-t]")
...
if argc > 1:
    try:
        opts, args = getopt.getopt(sys.argv[1:], "ost")
    except getopt.error:
        usage()
        sys.exit(2)
...
for file in file_list:
    ...
    p = subprocess.Popen(["python3", "C:\\Users\\awong\\Documents\\Analyzer_Decoding_Files\\extract_temps.py", "-r", rotor_name, CREATE_OUTPUT_FILE, SAVE_PLOT, TIMESTAMP_OVERLAY])
    p.wait()